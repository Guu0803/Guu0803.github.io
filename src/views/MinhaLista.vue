    ...
    <div class="tela">
        <div class="conteiner-cards">
            ...
            <div v-if="listaFilmes == 0 && listaSeries == 0 && listaAnimes == 0" class="aviso-lista-vazia">
                ...
                <div>
                    Adicione séries, animes e filmes favoritos que deseja assistir mais tarde clicando em Adicionar à Lista.
                </div>
            </div>
                ...
                <div class="fileira-cards">
                    <div v-for="filme in listaFilmes" :key="filme.nome">
                        <MiniCards :nome="filme.nome" :imagem="filme.imagem" :nota="filme.nota"
                            ...
                            :iconeRetirarDaLista="true" :faixaEtaria="filme.faixaEtaria"
                            :sinopseCompleta="filme.sinopseCompleta" :atualizarPagina="atualizarPagina"
                            :wallpaper="filme.wallpaper" :tipoDoTitulo="filme.tipoDoTitulo" :sinopse="true"
                            v-if="filme.tipoDoTitulo == 'filme'" />
                    </div>
                </div>
            </div>
                ...
                <div class="fileira-cards">
                    <div v-for="serie in listaSeries" :key="serie.nome">
                        <MiniCards :nome="serie.nome" :imagem="serie.imagem" :nota="serie.nota"
                            ...
                            :faixaEtaria="serie.faixaEtaria" :iconeRetirarDaLista="true" :tipoDoTitulo="serie.tipoDoTitulo"
                ...
                <div class="fileira-cards">
                    <div v-for="anime in listaAnimes" :key="anime.nome">
                        <MiniCards :nome="anime.nome" :imagem="anime.imagem" :nota="anime.nota"
                            ...
                            :download="anime.download" :adicionadoNaLista="anime.adicionadoNaLista"
                            :tipoDoTitulo="anime.tipoDoTitulo" v-if="anime.tipoDoTitulo == 'anime'"
                            :iconeRetirarDaLista="true" />
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        carregarLista() {
            ...
            if (usuario.minhaLista) {
                usuario.minhaLista.forEach(this.element)
            }
        },
        element(value) {
            if (value.tipoDoTitulo == 'filme') {
